...
const Month = () => {
  ...
  console.log(end)
  const monthStart = moment().month(moment().month()-1).startOf('month').format('YYYY-MM-DD HH:mm');
  const monthEnd = moment().month(moment().month() - 1).endOf('month').format('YYYY-MM-DD HH:mm');
